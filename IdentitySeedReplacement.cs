...
// In this exmaple the hard-coded table Id is 10013 (system prebuilt Risk Exceptions table)

decimal tableId = 10013;
decimal recordId = record.GetValue<int>("Id");
decimal multiplier = 1000000000;

return tableId * multiplier + recordId; // assuming a record Id of 5 for this example the result unique record Id would be 10013000000005
...
// Assumming a record Id of 5 for this example the unique Id return by this formula would be 10013000000005
// To reverse the unique record Id into it's two components you would use the following formula

// decimal UniqueRecordId = record.GetValue<int>("UniqueRecordIdField");  // value from field for this example is 10013000000005
